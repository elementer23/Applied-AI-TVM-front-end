  ...
  return (
    <div className="section right-section">
      ...
      <div className="chat-input-row">
        <input type="text" value={input} onChange={(e) => (e.target.value)} className="chat-input" placeholder="Tekstvak voor eventuele toelichting" />
        <button className="send-btn" onClick={handleSend}>Verstuur</button>
